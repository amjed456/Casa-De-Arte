...
// Create a fixed array of animation durations instead of random
...
export default function Gallery() {
  ...
  // Function to get animation duration based on index
          ...
          <div className="grid grid-cols-2 gap-8 mb-16">
            {galleryItems.slice(4, 8).map((item, index) => (
              <Card 
                ...
                style={{
                  boxShadow: "0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)",
                  animation: `swing ${getAnimationDuration(index + 4)}s ease-in-out infinite`,
                  transformOrigin: "50% -20px"
                }}
              >
                <div className="absolute -top-2 left-1/2 w-4 h-4 bg-gray-300 rounded-full transform -translate-x-1/2 shadow-md z-10" />
